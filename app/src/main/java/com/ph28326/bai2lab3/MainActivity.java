...
import com.ph28326.bai2lab3.app.AppController;

import org.json.JSONArray;
import org.json.JSONObject;

public class MainActivity extends AppCompatActivity {
    private String urlJsonObj = "http://192.168.1.11:800/personObject";

    private String urlJsonArry = "http://192.168.1.11:800/personArray";
    ...
    private void makeJsonArrayRequest() {
        ...
        JsonArrayRequest arrayRequest = new JsonArrayRequest(urlJsonArry,
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Log.d("obj","Error: " + volleyError.getMessage());
                hideDialog();
            }
    ...
    private void makeJsonObjectRequest() {
        ...
        JsonObjectRequest jsonObjReq = new
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Log.d("arr","Error: " + volleyError.getMessage());
                hideDialog();
            }
        });
        // Adding request to request queue
